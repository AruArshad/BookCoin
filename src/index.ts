...
async function createTokenMetadata(
  ...
  const buffer = fs.readFileSync("assets/book.png")

  const file = toMetaplexFile(buffer, "book.png")
...
async function main() {
  ...
  await createTokenMetadata(
    ...
    "Book Token",
    "BOOK",
    "Get this token to unlock our courses in our site"
  )
  ...
  const recipientTokenAccount = await token.getOrCreateAssociatedTokenAccount(
    ...
    user,
    mint,
    new web3.PublicKey("4HaGf2rtFUrwkeAkWfR6rtYirrdjnMr3qHaWoBwVxx1P")
  )
